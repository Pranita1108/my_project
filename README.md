...
### Project Overview
This project demonstrates a CI/CD pipeline for deploying a Zomato Clone application using GitHub, Jenkins, SonarQube, Docker, Kubernetes, Prometheus, Grafana, and ArgoCD.
